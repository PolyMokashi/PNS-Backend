...
itemRouter
  ...
  .post(function (request, response) {
    // console.log("POST /items2 : ",request.body);

    var item = new Item({UserData : request.body.UserData,Textlength:request.body.Textlength});
...
itemRouter
  ...
  .patch(function (request, response) {
    // console.log("PATCH /items2/:itemId");
